...
const SERVICES = {
  ...
  "IV Drips": [
    ...
    { name: "Slimming Drip Standard", description: "3 in 20,000", price: 8000 },
    { name: "Slimming Drip Supreme", description: "6 in 50,000", price: 10000 },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-2xl px-4 pb-12 sm:px-6 flex flex-col">
        ...
        {/* ── Category accordion ── */}
        <div className="flex flex-col gap-2 grow [&>div]:border-t">
        ...
        <div className="relative mt-16 overflow-hidden rounded-3xl bg-[#005a5f] px-8 py-14 text-center text-white">
          ...
          />
          <p className="relative mb-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-teal-200/70">
            Ready to begin?
          </p>
          <h2 className="relative text-3xl font-light sm:text-4xl">
            Book your&nbsp;<span className="font-semibold">consultation</span>
          </h2>
          <p className="relative mt-4 text-sm font-light text-white/60">
            Speak with our expert aestheticians and find the perfect treatment
            for you.
          </p>
          <a
            ...
            className="relative mt-8 inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 text-sm font-semibold text-[#005a5f] transition-all hover:bg-teal-50 hover:shadow-lg"
          >
            Book via WhatsApp
            <svg
